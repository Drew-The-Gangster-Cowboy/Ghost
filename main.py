...
ishant72 = commands.Bot(description='GHOSTBOT',
                           command_prefix='.',
                           self_bot=True,
                           intents=intents)
status_task = None

ishant72.remove_command('help')

ishant72.whitelisted_users = {}

ishant72.antiraid = False
...
$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
$$$$$$$$$$|         $$$$$$$$$$|       |$$$$$$$$$$| |$$$$| |$$$$$$$$$$|        |$$$$$$$$$|  \$$$$$| |$$$$$$$$$$|        |$$$$$$$$|
$$$$$$$$$$|__    ___$$$$$$$$$$|   ____|$$$$$$$$$$| |$$$$| |$$$$$$$$$$|  ____  |$$$$$$$$$|   \$$$$| |$$$$$$$$$$|        |$$$$$$$$|                $$$$$$$$$$$$$|  |$$$$$$$$$$$$$|  |$$$$$$$$$$$$$$$| |$$$$| |$$$$$$$$$$| |$$$$| |$$$$$$$$$|    \$$$| |$$$$$$$$$$$$$|  |$$$$$$$$$$$| .DISCORD-ISHANT72
$$$$$$$$$$$$$|  |$$$$$$$$$$$$$|  |$$$$$$$$$$$$$$$| |$$$$| |$$$$$$$$$$| |$$$$| |$$$$$$$$$| |$\ \$$| |$$$$$$$$$$$$$|  |$$$$$$$$$$$| .INSTA HANDLE -
$$$$$$$$$$$$$|  |$$$$$$$$$$$$$|__    |$$$$$$$$$$$|  ____  |$$$$$$$$$$|        |$$$$$$$$$| |$$\ \$| |$$$$$$$$$$$$$|  |$$$$$$$$$$$| ISHANT­­__JANGRA__
$$$$$$$$$$$$$|  |$$$$$$$$$$$$$$$$$\  |$$$$$$$$$$$| |$$$$| |$$$$$$$$$$|  ____  |$$$$$$$$$| |$$$\ \$ |$$$$$$$$$$$$$|  |$$$$$$$$$$$|
$$$$$$$$$$$$$|  |$$$$$$$$$$$$$$$$$|  |$$$$$$$$$$$| |$$$$| |$$$$$$$$$$| |$$$$| |$$$$$$$$$| |$$$$\   |$$$$$$$$$$$$$|  |$$$$$$$$$$$|
$$$$$$$$$$$|       |$$$$$$$$$$|      |$$$$$$$$$$$| |$$$$| |$$$$$$$$$$| |$$$$| |$$$$$$$$$| |$$$$$\  |$$$$$$$$$$$$$|  |$$$$$$$$$$$|
$$$$$$$$$$$|_______|$$$$$$$$$$|______|$$$$$$$$$$$| |$$$$| |$$$$$$$$$$| |$$$$| |$$$$$$$$$| |$$$$$$\ |$$$$$$$$$$$$$|  |$$$$$$$$$$$|
...
[+] -------------------------------- ] | [ S E L F B O T - {ishant72.user.name}  ] | [ ------------------------------------ [+]
""",
                1,
            )
        )
...
async def on_message(message):
    ...
    await ishant72.process_commands(message)
...
async def on_member_ban(guild, user):
    if ishant72.antiraid is True:
        try:
            async for entry in guild.audit_logs(
                    limit=1, action=discord.AuditLogAction.ban):
                if (guild.id in ishant72.whitelisted_users.keys()
                        and entry.user.id
                        in ishant72.whitelisted_users[guild.id].keys()
                        and entry.user.id != ishant72.user.id):
...
async def antinuke(ctx, antiraidparameter=None):
    ...
    if str(antiraidparameter).lower() == 'true' or str(
        ...
        await ctx.send(
            f'- **[! ERROR] ** `USAGE : {ishant72.command_prefix}antiraid [true/false]`'
        )


#WWHITE CMD=======================================================================================================================================================================================================
#ADDTION WHITELIST
@ishant72.command(aliases=['wl'])
async def whitelist(ctx, user: discord.Member = None):
    await ctx.message.delete()
    if user is None:
        await ctx.send(
            f'[ERROR]: USAGE :  {ishant72.command_prefix}whitelist <user>')
    else:
        if ctx.guild.id not in ishant72.whitelisted_users.keys():
            ishant72.whitelisted_users[ctx.guild.id] = {}
        if user.id in ishant72.whitelisted_users[ctx.guild.id]:
            await ctx.send("- `" + user.name.replace("*", "\*").replace(
                "`", "\`").replace("_", "\_") + "#" + user.discriminator +
                           "`-` ** ALREADY WHITELISTED [!]**")
        else:
            ishant72.whitelisted_users[ctx.guild.id][user.id] = 0
            await ctx.send("# GHOSTBOT\n`-` **WHITELISTED**" + user.name.replace(
                "*", "\*").replace("`", "\`").replace("_", "\_") + "#" +
                           user.discriminator + "`")


#CHECK WHITELIST
@ishant72.command(aliases=['showwl'])
async def whitelisted(ctx, g=None):
    await ctx.message.delete()
    if g == '-g' or g == '-global':
        whitelist = '# GHOSTBOT\n`-`**ALL WHITELISTED USERS:**`\n'
        for key in ishant72.whitelisted_users:
            for key2 in ishant72.whitelisted_users[key]:
                user = ishant72.get_user(key2)
                whitelist += f'• {user.mention} ({user.id}) IN {ishant72.get_guild(key).name}\n'
        await ctx.send(whitelist)
    else:
        whitelist = f'# GHOSTBOT\n`-` **WHITELISTED USERS IN {ctx.guild.name}:**`\n'
        for key in ishant72.whitelisted_users:
            if key == ctx.guild.id:
                for key2 in ishant72.whitelisted_users[ctx.guild.id]:
                    user = ishant72.get_user(key2)
...
@ishant72.command(aliases=['removewl'])
async def unwhitelist(ctx, user: discord.Member = None):
    if user is None:
        ...
        if ctx.guild.id not in ishant72.whitelisted_users.keys():
            ...
            return
        if user.id in ishant72.whitelisted_users[ctx.guild.id]:
            ishant72.whitelisted_users[ctx.guild.id].pop(user.id, 0)
            user2 = ishant72.get_user(user.id)
...
#WHITELIST CLEAR
@ishant72.command(aliases=['clearwl', 'clearwld'])
async def clearwhitelist(ctx):
    await ctx.message.delete()
    ishant72.whitelisted_users.clear()
...
async def massdmfriends(ctx, *, message):
    for user in ishant72.user.friends:
        try:
            time.sleep(.1)
...
# NITRO GEN
@ishant72.command(aliases=["nitrogen"])
async def nitro(ctx):
    try:
        await ctx.message.delete()
        code = ''.join(
...
async def hack(ctx, user: discord.Member = None):
    ...
    email = [
        ...
        "@icloud.com", "@gmx.net", "@yandex.com", "@proton.me"
    ]
...
# STREAM CREATOR
@ishant72.command(aliases=["streaming"])
async def stream(ctx, *, message):
    stream = discord.Streaming(
        name=message,
        url="https://twitch.tv/https://Wallibear",
    )
    await ishant72.change_presence(activity=stream)
...
# PLAY CREATOR
@ishant72.command(aliases=["playing"])
async def play(ctx, *, message):
    game = discord.Game(name=message)
    await ishant72.change_presence(activity=game)
...
# WATCH CREATOR
@ishant72.command(aliases=["watch"])
async def watching(ctx, *, message):
    await ishant72.change_presence(activity=discord.Activity(
...
@ishant72.command(aliases=["listen"])
...
@ishant72.command(aliases=[
    "stopstreaming", "stopstatus", "stoplistening", "stopplaying",
    "stopwatching"
])
async def stopactivity(ctx):
    await ctx.message.delete()
    await ishant72.change_presence(activity=None, status=discord.Status.dnd)
    print(f"{reset}[ {cyan}{time_rn}{reset} ] {gray}({red}!{gray}) {pretty}{Fore.RED}ACTIVITY SUCCESFULLY STOPED?? ")
# MATHS
...
# CONNECT VC
@ishant72.command(aliases=['247'])
@commands.check(is_authorized)
async def connectvc(ctx, channel_id):
    try:
        channel = ishant72.get_channel(int(channel_id))
...
async def copyserver(ctx, source_guild_id: int, target_guild_id: int):
    source_guild = ishant72.get_guild(source_guild_id)
    target_guild = ishant72.get_guild(target_guild_id)
...
async def change_hypesquad(ctx):
    ...
    try:
        msg = await ishant72.wait_for('message', check=check, timeout=60)
...
# AVATAR
@ishant72.command(aliases=['av','ava'])
@commands.check(is_authorized)
...
# PURGE CMD...
@ishant72.command(aliases=['purge, clear'])
@commands.check(is_authorized)
...
# NSFW
@ishant72.command(aliases=['fuck', 'fx', '18+', 'xxx', 'nsfw'])
async def waifu(ctx):
    try:
...
# SERVER BANNER
@ishant72.command(aliases=['serverbanner'])
...
# SERVER PFP
@ishant72.command(aliases=['guildpfp', 'serverpfp', 'servericon'])
...
async def nukezzz(ctx):
    ...
    message_text = '# FUCKED BY ishant :  https://discord.gg/way2apc ||@everyone||'
...
@ishant72.command(aliases=['bal', 'ltcbal'])
async def getbal(ctx, ltcaddress):
    ...
    message += f"`-` **ASKED BY** : `{ishant72.user.name}`\n"
...
#MESSAGE UPLOADER
@ishant72.command(name='send')
async def send_message(ctx, *, message: str):
    try:
        
        for channel_id in channel_ids:
            channel = ishant72.get_channel(channel_id)
...
# STATUS ROTATOR
ishant72.load_extension("status_rotator")


token = config.get('Token')
ishant72.run(token, bot=False)
